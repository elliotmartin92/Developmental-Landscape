...
# generate all relative log2FC vlaues for every gene in every cluster
...
write_rds(all_fold_changes_soma, "ShinyExpresionMap/Preprocessed_data/single_cell_seq_fold_changes_germarium_soma.RDS")
