...
if (pages_to_report == "DevProg" || pages_to_report == "all") {
  ...
  }else if (exists("ovary_map_dataset_plotted")){
    distPlot_cartoon_to_display = FALSE
    distPlot_legend_to_display = TRUE
    distPlot_map_to_display = TRUE
    ovary_map_text_raw =
      figure_legends_table %>%
      filter(plot == "ovary_map") %>%
...
```{r, echo=FALSE, fig.height = 0.25, fig.width = 8.5, fig.align = "center", eval=distPlot_legend_to_display, message=FALSE, warning=FALSE}
...
```{r echo=FALSE, fig.align="center", fig.cap=fig_nums("ovary_map_figure_legend"), fig.height=5, fig.width=14, message=FALSE, warning=FALSE, eval=distPlot_map_to_display}
source("server_modules/ovary_map.R")
...
```{r, echo=FALSE, fig.height = 6, fig.width= 6, fig.align = "center", eval=heatmap_to_display, fig.cap=fig_nums("heat_map"), message=FALSE, warning=FALSE}
heat_map_global
```
<br><br><br><br>
```{r, echo=FALSE, fig.height = 4, fig.width= 12, fig.align = "center", eval=violin_to_display, fig.cap=fig_nums("violin_plot"), message=FALSE, warning=FALSE}
