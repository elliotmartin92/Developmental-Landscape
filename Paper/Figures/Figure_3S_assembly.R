...
FigureS4 = FigureS4 %>% 
  fill_panel(FigureS4A, label = "A", scaling = "fit", panel_clip = "on", row = 2:3, column = 3:6) %>% 
  fill_panel(FigureS4B, label = "B", scaling = "fit", panel_clip = "on", row = 5:6, column = 3:6) %>% 
  fill_panel(FigureS4C, label = "C", scaling = "fit", panel_clip = "on", row = 8:9, column = 3:6) %>% 
  fill_panel(FigureS4D, label = "D", scaling = "fit", panel_clip = "on", row = 10:11, column = 3:6)
FigureS4

ggsave(filename = "Supplemental_Figure3.pdf", plot = FigureS4, path = "../Paper/Figures/", width = 8.5, height = 11, device = cairo_pdf)
