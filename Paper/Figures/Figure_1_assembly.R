...
Figure1 = Figure1 %>% 
  fill_panel(Figure1_A1, label = "A", label_just = "bottom", scaling = "none", panel_clip = "off", row = 3:4, column = 3:5, family = "Helvetica") %>% 
  fill_panel(Figure1_B1, label = "B", label_just = "bottom", scaling = "none", panel_clip = "off", row = 5:6, column = 3:5, family = "Helvetica") %>% 
  fill_panel(Figure1_C, label = "C", label_just = "bottom", scaling = "none", panel_clip = "off", row = 7:8, column = 3:4, family = "Helvetica") %>% 
